"""app_aheid.py - Project script (example).
...
DATASET Source: https://raw.githubusercontent.com/fivethirtyeight/data/master/airline-safety/airline-safety.csv
Assumptions:
...
uv run python -m datafun.app_airline_aheid
...
EXAMPLE_NUMERIC_COL: Final[str] = "incidents_00_14"
...
SCATTER_X_COL: Final[str] = "incidents_85_99"
SCATTER_Y_COL: Final[str] = "incidents_00_14"

BOX_Y_COL: Final[str] = "fatalities_85_99"

# CUSTOM: Assign readable labels for the charted variables.

SCATTER_X_LABEL: Final[str] = "Incidents 1985-1999"
SCATTER_Y_LABEL: Final[str] = "Incidents 2000-2014"

BOX_Y_LABEL: Final[str] = "Fatalities 1985-1999"
...
def make_plots(df_clean: pd.DataFrame) -> None:
    ...
    plt.savefig("docs/airline_scatter.png", bbox_inches="tight")
    ...
    # Rotate labels for airline names
    box_plt.tick_params(axis="x", labelrotation=90, labelsize=8)
    plt.savefig("docs/airline_boxplot.png", bbox_inches="tight")


plt.savefig("docs/airline_analysis.png")
